...
function StudyAssistantChatPageContent({ user }) {
  ...
  // Fetch all documents and start polling for any in-processing
  ...
  const toggleTagExpansion = (t) => {
    setExpandedTags((prev) => ({ ...prev, [t]: !prev[t] }))
  }
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-2 border-t border-white/10">
                ...
                <div className="space-y-2">
                  {Object.entries(groupedDocuments).map(([tg, docsInGroup]) => (
                    <div key={tg}>
                      <button
                        onClick={() => toggleTagExpansion(tg)}
                          ...
                          {docsInGroup.map((doc) => (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2 shrink-0">
                                <button
                                  onClick={() => handleViewDocument(doc.id, doc.filename, tg)}
