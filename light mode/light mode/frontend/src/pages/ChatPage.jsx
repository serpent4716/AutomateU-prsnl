...
import SidebarWrapper from "../wrapper/SidebarWrapper"; // adjusted import
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-2 space-y-1">
              {filteredUsers.map((user) => (
                <div
                  key={user.id}
                  className={`cursor-pointer transition-all duration-200 p-3 rounded-lg hover:bg-gray-100 ${selectedUser === user.id ? "bg-blue-50 border-l-4 border-blue-500" : ""
                    }`}
              ...
              <div className="flex-1 p-4 overflow-y-auto">
                <div className="space-y-4">
                  {currentMessages.map((msg) => (
                    ...
                    >
                      <div
                        className={`max-w-[70%] rounded-lg px-4 py-2 ${msg.senderId === "current-user"
                      ...
                      >
                        ...
                        <p
                          className={`text-xs mt-1 ${msg.senderId === "current-user" ? "text-blue-100" : "text-gray-500"
                            }`}
                        >
