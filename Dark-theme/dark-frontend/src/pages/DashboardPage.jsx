...
import "../components/ProductivityMetrics/ProductivityMetrics.css"
...
export default function DashboardPage() {
  ...
  const studyingTools = [
  {
    ...
    gradient: "from-emerald-400 via-green-300 to-emerald-500", // 🌿 Bright green gradient
    bgGradient: "from-emerald-950/40 to-emerald-900/20",
    glow: "rgba(16, 185, 129, 0.45)", // 💚 intensified glow
  ...
  },
  {
    ...
    gradient: "from-purple-400 via-pink-400 to-violet-500", // 💜 Pink-purple gradient
    bgGradient: "from-purple-950/40 to-purple-900/20",
    glow: "rgba(192, 132, 252, 0.45)", // 💫 stronger violet glow
    animation: "icon-spin",
  },
  {
    icon: Zap,
    ...
    gradient: "from-amber-400 via-orange-400 to-yellow-400", // ⚡ warmer amber-yellow
    bgGradient: "from-amber-950/40 to-amber-900/20",
    glow: "rgba(251, 191, 36, 0.45)", // 🌟 golden glow
  ...
  },
  {
    ...
    gradient: "from-cyan-400 via-sky-400 to-teal-400", // 🩵 cool cyan blend
    bgGradient: "from-cyan-950/40 to-cyan-900/20",
    glow: "rgba(34, 211, 238, 0.45)", // 💧 neon blue glow
...
const productivityTools = [
  {
    ...
    path: "/tasks",
    gradient: "from-blue-400 via-cyan-400 to-indigo-400", // 🔵 ocean blue gradient
    bgGradient: "from-blue-950/40 to-blue-900/20",
    glow: "rgba(96, 165, 250, 0.45)", // 💡 soft blue glow
    animation: "icon-bounce",
  },
  {
    icon: CalendarDays,
    ...
    path: "/attendance",
    gradient: "from-violet-400 via-purple-400 to-indigo-400", // 💜 calm violet blend
    bgGradient: "from-purple-950/40 to-purple-900/20",
    glow: "rgba(167, 139, 250, 0.45)", // 🌌 lavender glow
    animation: "icon-float",
  },
  {
    icon: Search,
    ...
    path: "/lost-found",
    gradient: "from-teal-400 via-green-400 to-emerald-400", // 💚 teal-green gradient
    bgGradient: "from-teal-950/40 to-teal-900/20",
    glow: "rgba(45, 212, 191, 0.45)", // 🌿 mint glow
    animation: "icon-spin",
  },
  {
    icon: Users,
    ...
    path: "/chat",
    gradient: "from-pink-400 via-rose-400 to-fuchsia-400", // 💗 pink-fuchsia gradient
    bgGradient: "from-pink-950/40 to-pink-900/20",
    glow: "rgba(244, 114, 182, 0.45)", // 🌸 rosy glow
    animation: "icon-pulse",
  },
]
  ...
  return (
    <div className="relative min-h-screen font-figtree overflow-hidden bg-black ">
      {/* <CHANGE> Added animation styles to head */}
        ...
        <main className="flex-1 p-6 lg:p-10 font-figtree">
          <div className="mb-10">
            ...
            <div className="max-w-2xl relative group font-figtree">
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl flex items-center gap-3 px-5 py-3 shadow-md hover:shadow-orange-500/10 transition-all duration-300 hover:border-white/20">
                ...
                />
                {searchQuery === "" && (
                  <div className="absolute left-12 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm pointer-events-none font-figtree">
                    <TextType
                      text={[
                        "Search for tools ",
                        "Find your AI assistant ",
                        "Try 'lost ID card' or 'notes' ",
                        "Explore AutomateU features ",
                      ]}
                      typingSpeed={60}
                      pauseDuration={1800}
                      showCursor={false}
          ...
          <div className="mb-12 font-figtree">
            <div className="mb-6 flex items-center gap-3">
              ...
              {/* <CHANGE> Made "Study Tools" title bold */}
                ...
                return (
                  ...
                  >
                    <SpotlightCard spotlightColor={tool.glow}>
                      ...
                      >
                        {/* <CHANGE> Added animated icon with hover animation class */}
                        <div className="p-3 rounded-xl w-fit bg-white/5">
                          <Icon className={`h-5 w-5 text-white/90 ${tool.animation}`} />
                        </div>
                        <div>
                          <h3
                            className={`font-bold text-lg tracking-tight mb-1 transition-all duration-300 font-figtree ${
                              isHovered
          ...
          <div className="mb-8 font-figtree">
            <div className="mb-6 flex items-center gap-3">
              ...
              {/* <CHANGE> Made "Productivity Tools" title bold */}
              <h2 className="text-2xl lg:text-2xl font-extrabold text-white tracking-tight font-figtree">
                Productivity Tools
              </h2>
            </div>
