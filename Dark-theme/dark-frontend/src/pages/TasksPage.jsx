...
const MOCK_TASKS = [
  {
    ...
    desc: "Create a modern and responsive landing page for the product launch",
    status: "in_progress",
    priority: "high",
  ...
  },
  {
    ...
    desc: "Create migration scripts for the new user schema",
    status: "todo",
    priority: "high",
  ...
  },
  {
    ...
    desc: "Add JWT-based authentication to all API endpoints",
    status: "todo",
    priority: "high",
  ...
  },
  {
    ...
    desc: "Review and merge pending pull requests from the team",
    status: "done",
    priority: "medium",
    due_date: "2025-12-05T00:00:00",
    estimated_hours: 2,
    user_id: 1,
    tags: ["review"],
    team_id: 1,
  ...
  },
  {
    ...
    desc: "Address reported bugs in the payment module",
    status: "done",
    priority: "high",
    due_date: "2025-12-03T00:00:00",
    estimated_hours: 3,
    user_id: 2,
    tags: ["bugfix"],
    team_id: 1,
                ...
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <form
                      ...
                      className="space-y-3 p-4 bg-white/5 border border-white/10 rounded-lg"
                    >
                      ...
                      <button
                        type="submit"
                        className="w-full h-10 px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white rounded-md text-sm font-medium"
                      >
                        Create Team
                      </button>
                    </form>
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="w-full h-10 px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-md text-sm font-medium"
                      >
                        Join Team
                      </button>
                    </form>
                      ...
                      .map((task) => (
                        ...
                        >
                          ...
                          <div className="flex flex-wrap gap-2 mb-3 ml-7">
                            <span
                              className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ${priorityColors[task.priority]}`}
                            >
                              {task.priority}
                            </span>
                            {task.tags.map((tag) => (
                              <span
                                key={tag}
                                className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium bg-white/5 text-gray-300 border border-white/10"
                              >
                                {tag}
                              </span>
                            ))}
      ...
      >
        ...
        <form id="task-dialog-form" onSubmit={handleSubmit}>
              ...
              <div className="col-span-2">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {formData.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center gap-2 rounded-md px-2 py-1 text-xs font-medium bg-white/10 text-gray-300 border border-white/10"
                    >
                      {tag}
          ...
          <div className="px-6 py-4 border-t border-white/10 bg-white/5 flex justify-end gap-3">
            ...
            <button
              type="submit"
              className="h-10 px-4 rounded-md bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white text-sm font-medium"
            >
...
export default function TasksPage() {
  ...
  return <TasksPageContent user={mockUser} />
}
